    ...
    def safe_get(self, *args, **kwargs):
        ...
        while True:
            ...
            try:
                ...
                self.logger.warning('Getting Request: {} {} {}'.format(str(urlRequest), str(proxyAddress))
                response = requests.get(urlRequest, headers=header , timeout=15, proxies=)
    ...
    def safe_get(self, *args, **kwargs):
        ...
        while True:
            ...
            try:
                ...
                urlRequest = args[0]
                header = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:64.0) Gecko/20100101 Firefox/64.0','X-Requested-With': 'XMLHttpRequest'}
                response = requests.get(urlRequest, headers=header , timeout=15, proxies=self.getProxy())
